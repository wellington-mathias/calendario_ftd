...
class Evento extends CrudObject
{
    ...
    public function create()
    {
        ...
        $dti = date_create_from_format("Y-m-d", htmlspecialchars(strip_tags($this->dt_inicio)));
        $this->dt_inicio = date_format($dti, "Y-m-d");
        $dtf = date_create_from_format("Y-m-d", htmlspecialchars(strip_tags($this->dt_fim)));
        $this->dt_fim =  date_format($dtf, "Y-m-d");
